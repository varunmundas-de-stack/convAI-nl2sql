...
#         """
#         Resolve a metric by name or ID.
...
#         return len(self.find_time_windows(name)) > 0
    ...
    # --------------- PUBLIC API: Business Context Methods --------------- TO BE DELETED
    ...
    #     """
    #     Search metrics by name, description, or examples.
    #     """
    ...
    #     """
    #     Search dimensions by name, description, or examples.
    #     """
    #     query_lower = query.lower()
    #     results = []
    ...
    # --------------- PUBLIC API: Priority/Ranking Methods --------------- TO BE DELETED
