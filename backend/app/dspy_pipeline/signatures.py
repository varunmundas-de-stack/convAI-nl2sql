...
class ResolveScopeTime(dspy.Signature):
    """Determine sales scope and time block from classified query terms."""
    ...
    # Output fields for scope and time resolution
...
class ResolveDimensions(dspy.Signature):
    """Resolve dimensions, filters, and apply context-aware operations."""
